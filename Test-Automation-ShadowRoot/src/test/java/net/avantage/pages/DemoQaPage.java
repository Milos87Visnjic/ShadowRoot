...
public class DemoQaPage extends BasePage {
    ...
    public WebElement dinamycClickMeMessage;
    ...
    public void clickOnTheRightClickButton() {
        Actions actions = new Actions(Driver.get());
        actions.contextClick(rightClickButton).perform();
        System.out.println(rightClickMessage.getText());
    }

    public void verifyDinamycClickMeMessage(){
        BrowserUtils.waitForVisibility(dinamycClickMeMessage,3);
        Assert.assertTrue(dinamycClickMeMessage.isDisplayed());
        System.out.println(dinamycClickMeMessage.getText());
    }
